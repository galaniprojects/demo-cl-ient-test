...
test('Test Case 6: To create a Claim', async ({ page }) => {
  ...
  await page.locator('div > .react-select-container > .react-select__control > .react-select__indicators > .react-select__indicator > .css-8mmkcg').click();
  await page.locator('span[title="hendri4"]').first().click();
  await page.getByRole('button', { name: 'OK' }).click();
  await page.locator('input[type="text"]').fill('test6');
  await page.getByRole('button', { name: 'Create' }).click();

   expect(page.getByRole('cell', { name: 'test6', exact: true })).toBeVisible
});
...
await page.locator("section").filter({ hasText: /^Select action…$/ }).locator("svg").click();
...
await page.locator(".react-select__option--is-focused").click();
...
await page.getByRole("cell", { name: "Select action…", exact: true }).locator("svg").click();
await page.getByText("Request attestation", { exact: true }).click();
await page.locator(".selectReceiver > .react-select-container > .react-select__control > .react-select__indicators > .react-select__indicator > .css-8mmkcg").click();
await page.locator(".react-select__option--is-focused").click();
await page.getByRole("button", { name: "Request Attestation" }).click();
await page.getByRole("link", { name: "Messages" }).click();
await page.waitForTimeout(2000);
...
test('Test Case 11: To create a new delegate', async ({ page }) => {
  ...
  await page.locator('.selectReceiver > .react-select-container > .react-select__control > .react-select__indicators > .react-select__indicator > .css-8mmkcg').click();
  await page.click('.react-select__menu-list .react-select__option:first-child');
  await page.locator('.selectCType > .react-select-container > .react-select__control > .react-select__indicators > .react-select__indicator').click();
  await page.click('.react-select__menu-list .react-select__option:first-child');  
